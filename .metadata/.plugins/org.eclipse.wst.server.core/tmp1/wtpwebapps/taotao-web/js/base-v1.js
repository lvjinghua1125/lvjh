 ...
 */
function login() {
    return location.href = "http://sso.taotao.com/login.html";
}
function regist() {
...
function search(a) {
    var b = "http://search.taotao.com/search.html?keyword=" + encodeURIComponent(document.getElementById(a).value);
